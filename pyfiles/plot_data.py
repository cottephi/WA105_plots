...
def primer_load_data(wanted_param):
  ...
  if len(code) == 0:
    print("ERROR: " + wanted_param + " not found in ./param_list.txt")
    exit(0)
    
  code = code[:-1]
  first_line = subprocess.check_output("head -n1 " + sys.argv[3], shell=True)
  if code not in first_line:
    print("ERROR: " + code + ", code for " + wanted_param + ", not found in data file")
    exit(0)
...
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[0], LEM_Down_I[0], LEM_Up_V[0], LEM_Up_I[0], tmin, tmax, "LEM_1")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[1], LEM_Down_I[1], LEM_Up_V[1], LEM_Up_I[1], tmin, tmax, "LEM_2")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[2], LEM_Down_I[2], LEM_Up_V[2], LEM_Up_I[2], tmin, tmax, "LEM_3")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[3], LEM_Down_I[3], LEM_Up_V[3], LEM_Up_I[3], tmin, tmax, "LEM_4")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[4], LEM_Down_I[4], LEM_Up_V[4], LEM_Up_I[4], tmin, tmax, "LEM_5")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[5], LEM_Down_I[5], LEM_Up_V[5], LEM_Up_I[5], tmin, tmax, "LEM_6")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[6], LEM_Down_I[6], LEM_Up_V[6], LEM_Up_I[6], tmin, tmax, "LEM_7")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[7], LEM_Down_I[7], LEM_Up_V[7], LEM_Up_I[7], tmin, tmax, "LEM_8")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[8], LEM_Down_I[8], LEM_Up_V[8], LEM_Up_I[8], tmin, tmax, "LEM_9")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[9], LEM_Down_I[9], LEM_Up_V[9], LEM_Up_I[9], tmin, tmax, "LEM_10")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[10], LEM_Down_I[10], LEM_Up_V[10], LEM_Up_I[10], tmin, tmax, "LEM_11")
a = plot_LEM_GRID(time, date, GRID_1_V, GRID_1_I, LEM_Down_V[11], LEM_Down_I[11], LEM_Up_V[11], LEM_Up_I[11], tmin, tmax, "LEM_12")
